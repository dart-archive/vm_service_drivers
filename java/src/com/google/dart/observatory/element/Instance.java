...
public class Instance extends Element {
  ...
  public List<MapAssociation> getAssociations() {
    JsonArray array = (JsonArray) json.get("associations");
    int size = array.size();
  ...
  /**
   * The length of a List instance. Provided for instance kinds: List Map Uint8ClampedList Uint8List
  ...
  /**
   * The type bounded by a BoundedType instance - or - the referent of a TypeRef instance. The value
   * will always be of one of the kinds: Type, TypeRef, TypeParameter, BoundedType. Provided for
   * instance kinds: BoundedType TypeRef
   */
